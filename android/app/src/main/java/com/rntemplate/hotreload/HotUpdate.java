...
public class HotUpdate {
    ...
    public HotUpdate(String latestJSBundleFile) {
        this.mReactInstanceManager = MainApplication.getInstance().getReactInstanceManager();
        this.mReactApplicationContext = MainApplication.getInstance().getReactApplicationContext();
