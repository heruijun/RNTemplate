package com.mgzf.nativelikeruntime.constants;
...
public class FileConstant {
    ...
    public static final String jS_BUNDLE_DOWNLOADED = JS_PATCH_LOCAL_FOLDER + "/" + JS_BUNDLE_LOCAL_FILE;
    public static final String jS_BUNDLE_DOWNLOADED_META = JS_PATCH_LOCAL_FOLDER + "/" + JS_BUNDLE_LOCAL_FILE_META;
